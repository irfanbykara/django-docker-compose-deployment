...
var modal = document.getElementById("categories_modal");

// Get the button that opens the modal
var btn = document.getElementById("categoriesModalButton");
...
function open_records_modal(){
var modal = document.getElementById("records_modal");

// Get the button that opens the modal
var btn = document.getElementById("recordsModalButton");
...
function open_pr_modal(){
var modal = document.getElementById("pr_modal");

// Get the button that opens the modal
var btn = document.getElementById("prButton");
